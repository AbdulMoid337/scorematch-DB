  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 h-auto lg:h-[calc(100vh-150px)]">
      ...
      <div className="flex-1 flex flex-col min-h-[600px]">
        <div className="mb-4 flex justify-between items-center bg-white dark:bg-slate-900 p-4 rounded-lg shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                // Optional: Clear lineup or try to adapt positions?
                // For simplicity, we keep the index based mapping.
                // Since indexes 0-10 generally map to GK-DEF-MID-FWD roughly, it might look okayish,
                // but position roles change.
              }}
              className="bg-gray-50 dark:bg-slate-800 border border-gray-300 dark:border-gray-700 rounded-md px-3 py-1.5 text-sm font-medium focus:ring-2 focus:ring-blue-500 outline-none transition-all"
            >
        ...
        <div className="relative flex-1 bg-linear-to-b from-green-600 to-green-700 rounded-xl shadow-2xl border-4 border-white/20 overflow-hidden mx-auto w-full max-w-2xl">
          ...
          {currentPositions.map((pos, index) => {
            ...
            return (
              ...
              >
                {player ? (
                  <div
                    className="group relative w-full h-full flex flex-col items-center cursor-grab active:cursor-grabbing animate-in zoom-in duration-300"
                    draggable
                  ...
                  >
                    ...
                    <button
                      ...
                      className="absolute -top-2 -right-2 w-5 h-5 bg-red-500 text-white rounded-full flex items-center justify-center text-xs opacity-0 group-hover:opacity-100 transition-opacity shadow-md hover:bg-red-600 z-20"
                      title="Remove"
                    >
                      ×
                    </button>
                    ...
                    {/* Player Circle */}
                    <div className="w-14 h-14 rounded-full bg-linear-to-br from-slate-100 to-slate-300 dark:from-slate-800 dark:to-slate-900 border-2 border-yellow-500 flex flex-col items-center justify-center shadow-lg ring-2 ring-black/20 z-10">
                  ...
                  <div className="w-12 h-12 rounded-full border-2 border-dashed border-white/30 flex items-center justify-center bg-white/5 hover:bg-white/10 transition-colors">
      ...
      <div className="w-full lg:w-80 bg-white dark:bg-slate-900 rounded-xl shadow-xl border border-gray-200 dark:border-gray-800 flex flex-col overflow-hidden max-h-[400px] lg:max-h-none">
        <div className="p-4 bg-gray-50 dark:bg-slate-800/50 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-10 backdrop-blur-md">
          ...
          <input
            ...
            className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        ...
        <div className="flex-1 overflow-y-auto p-2 space-y-2 custom-scrollbar">
          {availablePlayers.map((player) => (
            <div
              ...
              className="group flex items-center gap-3 p-2 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 cursor-grab active:cursor-grabbing border border-transparent hover:border-blue-100 dark:hover:border-blue-800/30 transition-all duration-200 select-none"
            >
              <div className="w-10 h-10 rounded-full bg-linear-to-br from-yellow-100 to-yellow-200 text-yellow-800 flex items-center justify-center font-bold text-sm border border-yellow-300 shadow-sm group-hover:scale-110 transition-transform">
                {player.data.level}
              </div>
